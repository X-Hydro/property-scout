...
class RISpider(StateSpider):
    ...
    def _normalize_feature(self, feature: dict, town_code: str) -> dict:
        ...
        record = {
            ...
            "last_sale_date": None,
            "building_sqft": _num(attrs, "building_sqft") if is_offmarket else None,
            "bedrooms": _num(attrs, "bedrooms") if is_offmarket else None,
            "bathrooms": _num(attrs, "bathrooms") if is_offmarket else None,
